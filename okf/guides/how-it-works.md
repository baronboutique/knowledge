...
1. **Browse and select.** Choose from product categories on baronboutique.com — Menswear, Womenswear, Screen Inspired, or Cashmere.
2. **Customize.** Select fabric, lining, and style options where available. Add to cart.
3. **Enter measurements.** In the cart, use the Add Measurements tab to enter body measurements manually or select from predefined sizes with adjustments. A comment box accepts special tailoring instructions.
...
- [Women's Measuring Guide](womens-body-measuring-guide.md)
- [Shipping Policy](../policies/shipping-and-delivery.md)
