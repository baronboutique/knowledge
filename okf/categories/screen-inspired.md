...
description: "Garments recreated from film and television references and cut to each wearer's measurements. These are independent recreations, not officially licensed merchandise."
...
- [Theatrical Villain](screen-inspired/theatrical-villain-tailoring.md)
- [Doctor Collection](screen-inspired/doctor-collection.md)
- [Spy Tailoring](screen-inspired/spy-tailoring.md)
- [Cyberpunk Trench Coats](screen-inspired/cyberpunk-trench-coats.md)
- [Victorian Detective](screen-inspired/victorian-detective.md)
- [Cinema Classics](screen-inspired/cinema-classics.md)

Screen Inspired Garments Made to Your Measurements — Trench Coats, Doctor Inspired, Spy Wear & More
...
- Theatrical Villains — The Joker: Villain tailoring with real drama: the Jack Nicholson 1989 Joker coat and tailcoat, the 2019 and purple Joker looks, and more character coats. Built in proper cloth so the menace reads as tailoring, not fancy dress.
- Cinema Classics — Cary Grant & Ocean’s 11: The golden-age and heist-film wardrobe: the [Cary Grant grey suit from North by Northwest](https://baronboutique.com/cary-grants-north-by-northwest-suit/), the Brad Pitt Ocean’s 11 rusty-tan suit, and other classic-cinem…
- Victorian Detective — Sherlock Holmes: The nineteenth-century detective wardrobe: the Sherlock Holmes frock coat from the 2009 film and related Victorian and Ulster coats, cut with true waist seams and full skirts.

Choose the character piece, or send a reference
Pick a listed garment and its fabric and options, or send us reference images of any screen look you want built. We study the silhouette, details, and cloth before cutting.

We send a free test garment
Before the final cloth is cut, we build a test version in cotton or a low-cost fabric to your measurements and ship it to your home by trackable courier.

You confirm the fit at home
Try it on and check the fit and the silhouette, then send your notes and photos. Nothing is cut in your final cloth until the fit is confirmed on your body.

We cut it in the correct fabric
...
**Q:** How does the bespoke process work for a screen inspired coat or suit?  
**A:** You share your measurements and choose the character piece you want. Baron Boutique cuts a free test coat first — a muslin or low-cost fabric version of the garment — and ships it to you before the final piece is made. You try it on, note any fit adjustments, and return the feedback. The final piece is then cut in the correct fabric. This two-stage process means the finished garment fits your body, not a size chart.

**Q:** Can you make the iconic long black trench coat — the one worn by Neo?  
**A:** Yes. The Neo inspired long trench coat is one of the most requested pieces in this collection. It is made in a medium-weight structured cotton with the correct floor-length silhouette, wide lapels, and deep back vent. The leather Reloaded version and the white long coat as seen in the sequel are also available. Both are made to your exact measurements.

**Q:** Which Doctor inspired coats and jackets are available?  
**A:** The collection covers multiple Doctor inspired styles: the long bohemian coat as worn by the Fourth Doctor, the Edwardian frock coat as worn by the First Doctor, the black coat as worn by the Second Doctor, the jacket as worn by the Seventh Doctor, the blue and brown pinstripe suits as worn by Tennant, and the navy velvet coat as worn by Capaldi. Each is made to your measurements and can be adjusted for lining, button choice, and fit.

**Q:** What spy inspired suits and outfits can you make?  
**A:** The spy inspired range covers a wide selection — the classic three-piece pinstripe suit, the naval peacoat, the silk dinner jacket, the suede blouson jacket, and several more. That is just a fraction of what can be made. Any iconic spy inspired look is available. Send a reference photo and the team will build it to your exact measurements.
...
**Q:** Are these screen inspired garments or just loosely inspired-by versions?  
**A:** Every piece is made to capture the look and feel of the original as closely as possible, given fabric availability and fit requirements. Reference images are used throughout the construction process to guide the silhouette, details, and fabric choice. Where exact fabrics are no longer commercially available, the closest equivalent is sourced. The goal is a wearable garment that looks right on screen and in person, not a loose interpretation.

**Q:** Can I wear these pieces day to day, or are they only for cosplay and conventions?  
**A:** Both. Because these are real tailored garments in proper cloth rather than costume-grade polyester, many read as distinctive everyday pieces as much as convention or cosplay wear. The Tenth Doctor pinstripe suits, the Cary Grant grey suit, the Neo trench, and the spy tailoring in particular work as striking real-world clothing. The more theatrical pieces, such as the Dooku cape or the Joker tailcoat, are built for events, cosplay, stage, and collectors, but are still made to be genuinely worn rather than displayed.

**Q:** Do I need a tailor to take my measurements?  
**A:** No. Every product page includes measurement instructions, and most customers complete them in about fifteen minutes with a soft tape measure and a second person to help. Small errors are normal, which is exactly what the free test garment is for: you confirm the fit at home on the test piece before we cut the final cloth, so no prior tailoring experience is needed to order.

**Q:** Can you make a screen inspired coat or suit not already listed?  
...
- [All Screen Inspired products](../products/screen-inspired/index.md)
